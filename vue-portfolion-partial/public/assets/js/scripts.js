...
$( document ).ready(function() {
    ...
    $window.on('scroll', function () {
        if ($(window).scrollTop() > 100) {
           ...
           /*  $("#logo").attr('src', 'assets/img/portfolion_logo_black.svg');
            $("#hamburger").attr('src', 'assets/img/hamburger_black.svg'); */
        } else {
            $('.main-header-area').removeClass('navbar-sticky');
            /* $("#logo").attr('src', 'assets/img/portfolion_logo.svg');
            $("#hamburger").attr('src', 'assets/img/hamburger.svg'); */
        }
    });
